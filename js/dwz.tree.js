 ...
 */
 ...
 var icon_self="";
 if( typeof(node.attr('param'))=="undefined") {icon_self="file";}else{icon_self=node.attr('param');}
 $(">div",node).prepend("<div  class='node'></div>"+(op.ckbox?"<div class='ckbox "+checked +"'></div>":"")+(op.icon?"<div class='"+icon_self +"'></div>":""));
 					addSpace(op.level, node);
